...
https://xubuntu.org/ + [Caligula Burning Tool](https://github.com/ifd3f/caligula) or [Rufus USB Writer](https://rufus.ie/en/) for Windows users
...
simple-scan \
pdfarranger atril \
htop glances hardinfo whowatch arp-scan nmap nethogs wireshark speedtest-cli traceroute mtr net-tools iperf3 ipcalc \
...
- Copy text from images and documents - simple tools for text recognition - (tutorial [here](https://youtu.be/LzcoGR6I1yA))
  - NAPS2 https://www.naps2.com/ (.Deb)
  - Frog https://github.com/TenderOwl/Frog (FlatPak or Snap)
...
- BalenaEtcher https://www.balena.io/etcher/ (not recommended)
...
- or create an **Application.desktop** file:
   ...
   # Position Icon file
   sudo cp blender.svg /usr/share/pixmaps/
   # Or if already exist somewhere, maybe look at:
   sudo find /usr/share/icons/ -type f -name '*blender*'
